...
This is the Windfall Receipt Scanning SDK
  ...
  s.vendored_frameworks = ["WindfallSDK.framework","WindfallSDK.framework/Frameworks/WFLogoModel.framework"]

  #this for blink 2.0 and above
  #s.resource = "WindfallSDK.framework/MicroBlink.bundle"

  #this for blink 1.1.1
  s.resources = ["WindfallSDK.framework/*.zzip", "WindfallSDK.framework/windfall-intermediate.der", "WindfallSDK.framework/*.nib", "WindfallSDK.framework/*.png", "WindfallSDK.framework/*.wav"]
